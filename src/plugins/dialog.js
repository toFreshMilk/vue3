export default ({ store, app }, inject) => {
  inject('dialog', {
    ...
    init(option,size) {
      ...
      html += "<div class=\"txt\">" + option.msg + "</div>";
      html += "</div>";
    ...
    confirm(msg, fnc, cancelFnc, opt,size) {
      let option = {};
      let dialog = "[dialog-idx=" + this.openIdx + "]";
      let that = this;
      let w_size;
    ...
    snackbarNo: 0,
    openSnackbar(text) {
      const beforeSnack = document.querySelector('.snackbar_area[data-snackno="'+ this.snackbarNo +'"]')
      ...
      snack.setAttribute('data-snackno', this.snackbarNo);
      ...
      setTimeout(this.removeSnackbar, 100000, this.snackbarNo);
    },
